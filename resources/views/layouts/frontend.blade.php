    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="blocks">
                <ul class="menus nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('/')) ? 'active' : '' }}" href="{{ route('/') }}"><i class="fas fa-home">&nbsp;</i><span>Home</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('login')) ? 'active' : '' }}" href="{{ route('login') }}"><i class="fas fa-sign-in-alt">&nbsp;</i><span>Sign In</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('register/tutor')) ? 'active' : '' }}" href="{{ route('register.tutor') }}"><i class="fas fa-user-tie">&nbsp;</i><span>Tutor Registration</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('register')) ? 'active' : '' }}" href="{{ route('register') }}"><i class="fas fa-user-circle">&nbsp;</i><span>Guardian Registration</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('whytutorprovide')) ? 'active' : '' }}" href="{{ route('whytutorprovide') }}"><i class="fas fa-info-circle">&nbsp;</i><span>Why Tutor Provide</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('jobboard')) ? 'active' : '' }}" href="{{ route('jobboard.index') }}"><i class="fas fa-book-reader">&nbsp;</i><span>Available Tuitions</span></a>
                    </li>
                </ul>
            </div>
            <div class="blocks categories_hide_md">
                ...
                <div class="categories owl-carousel owl-theme">
                    <a href="{{ route('login') }}" class="item">
                        <div class="category">
                            <img src="{{ asset('assets/images/Bangla-Medium.jpg') }}" alt="">
                            <h4>Bangla Medium</h4>
                        </div>
                        <div class="category">
                            <img src="{{ asset('assets/images/English-Version.jpg') }}" alt="">
                            <h4>English Version</h4>
                        </div>
                        <div class="category">
                            <img src="{{ asset('assets/images/English-Mdium.jpg') }}" alt="">
                            <h4>English Medium</h4>
                        </div>
                    </a>
                    <a href="{{ route('login') }}" class="item">
                        <div class="category">
                            <img src="{{ asset('assets/images/Religious-Studies.jpg') }}" alt="">
                            <h4>Religious Studies</h4>
                        </div>
                        <div class="category">
                            <img src="{{ asset('assets/images/admission-test.jpg') }}" alt="">
                            <h4>Admission Test</h4>
                        </div>
                        <div class="category">
                            <img src="{{ asset('assets/images/arts.jpg') }}" alt="">
                            <h4>Arts</h4>
                        </div>
                    </a>
                    <a href="{{ route('login') }}" class="item">
                        <div class="category">
                            <img src="{{ asset('assets/images/language-learning.jpg') }}" alt="">
                            <h4>Language Learning</h4>
                        </div>
                        <div class="category">
                            <img src="{{ asset('assets/images/test-preparetion.jpg') }}" alt="">
        ...
        <div class="col-lg-3">
            <div class="blocks categories_hide_lg">
                <h5 class="title">Popular Categories</h5>
                <div class="categories owl-carousel owl-theme">
                    <a href="{{ route('login') }}" class="category item">
                        <img src="{{ asset('assets/images/Bangla-Medium.jpg') }}" alt="">
                        <h4>Bangla Medium</h4>
                    </a>
                    <a href="{{ route('login') }}" class="category item">
            ...
            <div class="blocks">
                <div class="youtube">
                    <a href="https://www.youtube.com/channel/UCOxKVjBONG8sdAk5EIQ2l1Q/videos">
                        <img src="{{ asset('assets/images/Youtube-logo-black.jpg') }}" alt="">
                    </a>
                </div>
            </div>
            <div class="blocks">
                ...
                <div class="content">
                    <ul class="feedback owl-carousel owl-theme">
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Barrister-Riaz-Mahmud.png') }}" class="rounded-circle" alt="Barrister Riaz Mahmud" style="width: 70px;">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Mortuja-Jamal.png') }}" class="rounded-circle" alt="Mortuja Jamal" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Zarna-Rashide-Akter.png') }}" class="rounded-circle" alt="Zarna Rashide Akter" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Sahabul-Alam.png') }}" class="rounded-circle" alt="Sahabul Alam" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Nasima-Akter.png') }}" class="rounded-circle" alt="Nasima Akter" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Anjumanara-Lata.png') }}" class="rounded-circle" alt="Anjumanara Lata" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Mohammad-Iqbal.png') }}" class="rounded-circle" alt="" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/guardian_feedback/Mofizur-Rahman.png') }}" class="rounded-circle" alt="Mofizur Rahman" style="width: 70px;">
                                <div class="media-body">
            ...
            <div class="blocks">
                ...
                <div class="content">
                    <ul class="feedback owl-carousel owl-theme">
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Md-Shakil-SK.png') }}" class="rounded-circle" alt="Md Shakil SK" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Mahima-Hoque.png') }}" class="rounded-circle" alt="Mahima Hoque" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Nafisa-Airin.png') }}" class="rounded-circle" alt="Nafisa Airin" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Sadman-Fahim.png') }}" class="rounded-circle" alt="Sadman Fahim" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Faisal-Moheuddin.png') }}" class="rounded-circle" alt="Faisal Moheuddin" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Minal-Hossain-Prodhan.png') }}" class="rounded-circle" alt="Minal Hossain Prodhan" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Hafizur-Rahman.png') }}" class="rounded-circle" alt="Hafizur Rahman" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Arifur-Rahman.png') }}" class="rounded-circle" alt="Arifur Rahman" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Kaniz-Jahan.png') }}" class="rounded-circle" alt="Kaniz Jahan" style="width: 70px;">
                                <div class="media-body">
                        ...
                        <li class="item">
                            <div class="media">
                                <img src="{{ asset('assets/images/tutor_feedback/Azezul-Huque.png') }}" class="rounded-circle" alt="Md Azezul Huque" style="width: 70px;">
                                <div class="media-body">
...
<footer class="footer">
    <div class="row">
        ...
        <div class="col-lg-5">
            <div class="aim">
                <h5>{{ config('app.name') }} Aim</h5>
                <p>{{ config('app.name') }}.com- Is The online tutor matching platform in Bangladesh. {{ config('app.name') }}.com helps students & parents connect with qualified Tutors in-person and online tutors in over different categories.</p>
            </div>
        </div>
    </div>
    <div class="copyright">
