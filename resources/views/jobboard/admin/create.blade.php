    ...
    <form id="createTutionJobForm" action="javaScript:;">
        ...
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="city_id">Select City</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_city_id">
            ...
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="locations_id">Select Location</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_locations_id">
        ...
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="categories_id">Select Category</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_categories_id">
            ...
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="courses_id">Select Class/Course</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_courses_id">
        ...
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="student_gender">Select Student Gender</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_student_gender">
            ...
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="institute_name">Institute Name</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_institute_name">
        ...
        <div class="uk-margin">
            <label class="uk-form-label uk-text-bold" for="subjects_id">Select Subjects</label>
            <div class="uk-margin">
                <label class="uk-text-bold"><input class="uk-checkbox" type="checkbox" id="checkall"> Check All</label>
                <span id="subjects_id"></span>
            </div>
            <p class="uk-margin-remove-top uk-text-small uk-text-danger error_subjects_id">
        ...
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="peferred_gender">Tutor gender reference</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_peferred_gender">
            ...
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="weekly">Days in a week</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_weekly">
        ...
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="salary">Salary</label>
                        <input id="salary" class="uk-input uk-form-large @error('salary') uk-form-danger @enderror" type="number" name="salary" placeholder="{{ __('Salary') }}" value="{{ old('salary') }}">
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_salary">
            ...
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1 bootstrap-datepicker">
                        <label class="uk-form-label uk-text-bold" for="hire_date">When Are You Looking To Hire</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_hire_date">
        ...
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        <label class="uk-form-label uk-text-bold" for="no_of_students">No. of student</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_no_of_students">
            ...
            <div class="uk-width-1-2@s">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1 bootstrap-timepicker">
                        <label class="uk-form-label uk-text-bold" for="tutoring_time">Tutoring Time</label>
                    ...
                    <p class="uk-margin-remove-top uk-text-small uk-text-danger error_tutoring_time">
        ...
        <div class="uk-margin">
            ...
            <p class="uk-margin-remove-top uk-text-small uk-text-danger error_requirements">
