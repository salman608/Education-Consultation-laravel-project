    ...
    <form id="uploadCredentialsForm" action="javaScript:;" enctype="multipart/form-data">
		...
		<div class="uk-margin">
	        ...
	        <p class="uk-margin-remove-top uk-text-danger error credential_type">
	            @error('credential_type') {{ $message }} @enderror
	        </p>
	    </div>
	    <div class="uk-grid-small" uk-grid>
	   	...
	   	<div class="uk-margin">
	        <button type="submit" class="uk-button uk-button-primary uk-button-large uk-width-1-1">{{ __('Send') }}</button>
	    </div>
   	</form>
...
$("#uploadCredentialsForm").submit(function() {
    ...
    axios.post('{{ route("tutor.profile.store_credentials") }}', formData, {
        headers: {
