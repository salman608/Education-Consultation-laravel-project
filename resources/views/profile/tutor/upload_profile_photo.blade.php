    ...
    <div class="uk-card-header uk-card-primary">
        <div class="uk-grid-small uk-flex-middle header_profile" uk-grid>
            <div class="uk-width-auto">
                <img class="uk-border-circle uk-box-shadow-medium" id="imgOutput" width="100" height="100" src="{{ (!empty($profile->photo)) ? asset('storage/upload/'.$profile->photo.'') : asset('storage/upload/default-profile.png') }}">
            </div>
    ...
    <div class="uk-card-body uk-text-center">
     ...
     <!-- Profile photo upload instruction  -->
      ...
      <div class="card-body" style="color:black;">
              ...
              <img  src="{{ asset('assets/images/male_example.jpg') }}" alt="" style="margin:auto">
              <h4 class="uk-text-center uk-text-bold uk-margin-small-top">Do & Don't Examples (Female)</h4>
              <img src="{{ asset('assets/images/female_example.jpg') }}" alt="" style="margin:auto">
      </div>
    </div>
</div>
...
$('#cropButton').on('click', function (ev) {
	...
	size: {
		...
		axios.post('{{ route("tutor.profile.store_profile_photo") }}', {"profile_photo":resp})
