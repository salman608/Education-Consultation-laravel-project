...
<div class="jobboard uk-card uk-card-default uk-card-body uk-card-small uk-text-small uk-margin-medium-bottom">
    <div class="uk-clearfix">
        <span class="uk-text-bold">Job ID - {{ $job->id }}</span>
    ...
    <div class="uk-text-capitalize"><strong>Salary :</strong> {{ (!empty($job->salary)) ? $job->salary.' Tk' : 'Negotiate' }}, <strong>Tutor gender preference :</strong> {{ $job->peferred_gender }}, <strong>No. of Students :</strong> {{ $job->no_of_students }}</div>
    <div class="">
