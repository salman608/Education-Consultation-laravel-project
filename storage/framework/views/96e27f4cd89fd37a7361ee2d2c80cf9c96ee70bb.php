...
<div class="jobboard uk-card uk-card-default uk-card-body uk-card-small uk-text-small uk-margin-medium-bottom">
    <div class="uk-clearfix">
        <span class="uk-text-bold">Job ID - <?php echo e($job->id); ?></span>
    ...
    <div class="uk-text-capitalize"><strong>Salary :</strong> <?php echo e((!empty($job->salary)) ? $job->salary.' Tk' : 'Negotiate'); ?>, <strong>Tutor gender preference :</strong> <?php echo e($job->peferred_gender); ?>, <strong>No. of Students :</strong> <?php echo e($job->no_of_students); ?></div>
    <div class="">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /home/tutorprovide/public_html/resources/views/component/joblist.blade.php ENDPATH**/ ?>