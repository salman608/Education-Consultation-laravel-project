    ...
    <div class="uk-margin uk-width-large uk-margin-auto">
		<form method="POST" action="<?php echo e(route('subjects.store')); ?>">
			...
			<div class="uk-margin">
	            ...
	            <?php echo e(Form::select('categories_id', $categories, null, ['id' => 'categories_id', 'placeholder' => 'Select category', 'class' => 'uk-select  uk-form-large'])); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
			...
			<div class="uk-margin">
	            ...
	            <?php echo e(Form::select('courses_id', [], null, ['id' => 'courses_id', 'placeholder' => 'Select course', 'class' => 'uk-select  uk-form-large'])); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="text" name="name" placeholder="<?php echo e(__('Subject Name')); ?>" required autofocus>  
	            </div>
	            <p class="uk-margin-remove-top uk-text-small uk-text-danger">
...
if (isset($messageCache)) { $message = $messageCache; }
	        ...
	        <div class="uk-margin">
	            <button type="submit" class="uk-button uk-button-primary uk-button-large uk-width-1-1"><?php echo e(__('Create Subject')); ?></button>
	        </div>
	    </form>
	</div>
</div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tutorprovide/public_html/resources/views/subjects/create.blade.php ENDPATH**/ ?>